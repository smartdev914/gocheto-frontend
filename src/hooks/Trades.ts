import { ChainId, Currency, CurrencyAmount, Pair, Token, Trade } from '@gocheto-dex/sdk'
...
function generateAllRoutePairs(tokenA?: Token, tokenB?: Token, chainId?: ChainId): [Token, Token][] {
    const bases: Token[] = chainId && chainId === ChainId.MAINNET || chainId === ChainId.PUPPYNET || chainId === ChainId.BSC_TESTNET || chainId === ChainId.RSK_TESTNET ? BASES_TO_CHECK_TRADES_AGAINST[chainId] : []
