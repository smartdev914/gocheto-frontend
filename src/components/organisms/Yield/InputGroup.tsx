...
import { SHIBASWAP_TOPDOG_ADDRESS, Token, TokenAmount } from '@gocheto-dex/sdk'
...
export default function InputGroup({
    ...
    const { deposit, withdraw, harvest, emergencyWithdraw } = useTopDog()
    ...
    return (
        <div className="woof_cards">
            <button
                onClick={() => router.push(`/add/${isWETH(token0Address, chainId)}/${isWETH(token1Address, chainId)}`)}
            ...
            >
                <Image height={20} alt='Add icon' width={20} src={AddIcon} className="rounded-full" />
            ...
            <div className="flex flex-col space-y-4 py-6 w-full">
                    ...
                    <div className="grid gap-4 grid-cols-2 px-4">
                            ...
                            <div className="flex items-center relative w-full mb-4 bg-input rounded">
                                ...
                                {account && (
                                    <Button
                                        ...
                                        className="relative right-4 bg-transparent p-3 focus:outline-none hover:bg-primary border border-low-emphesis rounded-full py-1 px-2 text-secondary text-xs font-medium whitespace-nowrap ml-3 max"
                                    >
                                        MAX
                                    </Button>
                                )}
                        ...
                        <div className="text-center col-span-2 md:col-span-1">
                            ...
                            <Button
                                ...
                                onClick={async () => {
                                    /*setPendingTx(true)
                                    await emergencyWithdraw(pid, pairSymbol)
                ...
                {pendingBone && Number(pendingBone) > 0 && (
                    <div className=" px-4">
                        ...
                        >
                            {isHarvestPending ? (
                                <Dots>WOOFING {formattedNum(pendingBone)} BONE</Dots>
                            ) : (
