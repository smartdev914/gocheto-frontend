import { CurrencyAmount, JSBI, Token, Trade } from '@gocheto-dex/sdk'
...
import AdvancedSwapDetailsSection from '../../swap/AdvancedSwapDetailsSection'
...
export default function Swap() {
    const loadedUrlParams = useDefaultsFromURLSearch({ input: undefined, output: undefined })
