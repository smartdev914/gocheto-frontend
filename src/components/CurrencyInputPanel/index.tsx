...
const CurrencySelect = styled.button<{ selected: boolean }>`
    ...
    font-size: 20px;
    font-weight: 500;
    background-color: rgb(34 37 64 / 1);
    min-width: 160px;
...
const StyledDropDown = styled(Image)<{ selected: boolean }>`
...
const InputGroupStyle: any = {
    backgroundColor: 'rgb(15 17 45 / 1)',
    borderRadius: '1rem',
    margin: '0.5rem',
    paddingTop: '0.5rem'
}
        ...
        <div id={id} style={InputGroupStyle} className={'pd-5 mb-2 relative ' + customStyle}>
            {!hideInput && (
                <>
                    {account && (
                        <div
                            onClick={onMax}
                            className="font-medium cursor-pointer text-xs text-low-emphesis balance absolute left-20 sm:left-auto sm:right-4"
                        >
            ...
            >
                    ...
                    >
                        <div className="flex">
                            ...
                            {pair ? (
                                ...
                                <div className="flex flex-1 flex-col items-start justify-center mx-3.5 pt-3 sm:pt-0">
                                    {label && (
                ...
                <div
                    ...
                    className="ml-4 flex items-center rounded space-x-3 p-3 w-full sm:w-3/5 currency-div"
                >
                    {!hideInput && (
                        <>
                            {account && label !== 'To' && (
                            ...
                            <NumericalInput
                                className="token-amount-input pr-4 xl:pr-0"
                                value={value}
                                onUserInput={val => {
                                    onUserInput(val)
                                }}
