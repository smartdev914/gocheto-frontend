...
import TableBonefolio from '../../TableBonefolio'
//Images
...
export default function Bonefolio() {
    const BonefolioContainer = styled.div`
        display: inline-flex;
        width: 100%;
        height: auto;
        //border: 2px solid yellow;
        text-align: center @media (max-width: 1200px) {
            display: block;
            //height: 100%;
        }
            ...
            <BoneSection className="relative">
                ...
                <Row className="p-0">
                    ...
                    <Col className="mt-4 pr-3">
                        <div className="image-div">
                            <Image alt='Bonefolio icon' src={BonefolioImage} width="40" height="40" />
                        </div>
                    </Col>
                </Row>
                <CardsubTitle className="title subtitle float-left yield_fonts">
                    Every Shiba Inu needs to check their stash
                </CardsubTitle>
                ...
                <BarContainer>
                    <BarSection>
                        ...
                        <DescriptionSection>
                            <DetailSection>
                                <TextSection style={{ float: 'left', lineHeight: '1.2rem', marginLeft: '10px' }}>
                                    Staked:
                                </TextSection>
                            ...
                            <DetailSection>
                                ...
                                <TextSection style={{ float: 'right', lineHeight: '1.2rem', color: '#b61e1e' }}>
                                    600
                                </TextSection>
                            </DetailSection>
                        </DescriptionSection>
