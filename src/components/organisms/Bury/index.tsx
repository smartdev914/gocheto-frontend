...
import BuryModal from './BuryModal'
            ...
            <div className="container pb-5 m-auto bury-container relative mobile-container" style={{ padding: '1rem' }}>
                <InnerDiv>
                    ...
                    <Row className="p-0">
                        ...
                        <Col>
                            <ImageDiv>
                                <Image alt='Bury icon' height={40} width={40} src="/images/home/bury_icon.svg" />
                            </ImageDiv>
                        </Col>
                    </Row>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 py-6 px-4">
                        <div>
                            <VCard
                                {...props}
                                url="/bury/shib"
