'use client'
import { CurrencyAmount, JSBI, LEASH, SHIBA_INU, Token, Trade } from '@gocheto-dex/sdk'
...
import BetterTradeLink, { DefaultVersionLink } from '../../swap/BetterTradeLink'
...
import { ArrowWrapper, BottomGrouping, SwapCallbackError, Wrapper } from '../../swap/styleds'
...
export default function Swap({ params } : { params: { currencies?: string[] } }) {
    const input = params.currencies?.[0] ?? undefined;
    const output = params.currencies?.[1] ?? undefined
    const loadedUrlParams = useDefaultsFromURLSearch({ input, output })
        ...
        swapCallback()
            ...
            .catch(error => {
                setSwapState({
                    ...
                    tradeToConfirm,
                    showConfirm,
                    swapErrorMessage: 'Transaction Failed. Please try again.',
                    txHash: undefined
                })
            })
    }, [
    ...
    if (account && chainId !== ChainId.MAINNET && chainId !== ChainId.PUPPYNET && chainId !== ChainId.SHIBARIUM && chainId !== ChainId.BSC_TESTNET && chainId !== ChainId.RSK_TESTNET) {
        return (
            <div>
                <div className="flex flex-col items-center justify-center h-screen">
                    <div className="text-2xl font-bold">Unsupported Network</div>
                    <div className="text-lg">Please switch to Ethereum Mainnet or Shibarium Network</div>
                </div>
            </div>
        )
    }
    ...
    return (
        <>
            ...
            <div className={'tokens-container px-4'}>
                <div className="dig-container flex container my-auto pb-10">
                    <div className="dig mx-auto w-full md:w-auto" id="digSection">
                        ...
                        <div className="wrapper mt-0 contents">
                            <div className="dig--inner">
                                <div className="left" style={{ marginRight: '0rem' }}>
                                    <div className="inner justify-start">
                                        <div className="top">
                                            ...
                                            <div className="image-div mt-2">
                                                <Image alt="swap image" src={SwapImage} width="40" height="40" />
                                            </div>
                                        </div>
                                                                ...
                                                                >
                                                                    {approval === ApprovalState.PENDING ? (
                                                                      ...
                                                                      approval === ApprovalState.APPROVED ? (
                                                                        ...
                                                                        'Approve ' +
                                                                        currencies[Field.INPUT]?.getSymbol(chainId)
                                                                    )}
                                                                </ButtonConfirmed>
                                                                <ButtonError
                                                                    onClick={() => {
            ...
            <SwapModal isOpen={showModal} onDismiss={handleDismiss} />
        </>
    )
}
