import { ChainId, CurrencyAmount, JSBI, Pair, Token, TokenAmount, WETH } from '@gocheto-dex/sdk'
        ...
        () =>
            chainId
                ? STAKING_REWARDS_INFO[
                      chainId
                  ]?.filter((stakingRewardInfo: { tokens: [Token, Token]; stakingRewardAddress: string }) =>
