...
import StakeDepositPanel from '../../organisms/Bury/StakeDepositPanel'
import BuryWithdrawlPanel from '../../organisms/Bury/BuryWithdrawlPanel'
import {
...
const SnapShot = props => {
    ...
    const getPairs = async () => {
        ...
        props.setLoading(true)
        const apiResult = await shibaExchange(EXCHANGE_URI).query({
            query: pairsQuery
        })
              ...
              <CardBody>
                <ListGroup>
                  {voteDetails.map( ( item, index ) => {
                    ...
                    <div className="col-lg-6 col-md-8 tabs--col">
