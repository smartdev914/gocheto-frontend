import { ChainId, Currency, ETHER, WETH, currencyEquals } from '@gocheto-dex/sdk'
                              ...
                              try {
                                  ...
                                  addTransaction(txReceipt, {
                                      summary: `Unwrap ${inputAmount.toSignificant(
                                          ...
                                          (chainId && chainId === ChainId.MAINNET || chainId === ChainId.PUPPYNET || chainId === ChainId.BSC_TESTNET || chainId === ChainId.RSK_TESTNET)
                                              ? chainId
                                              : ChainId.MAINNET
                                      )}`
                                  })
