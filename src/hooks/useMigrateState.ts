...
const useMigrateState: (tokenFetchKey: string, fetchTokenAddress: string) => MigrateState = (
    tokenFetchKey: string,
    ...
    }, [mode, state, account, provider, amount, migrate, migrateWithPermit, addTransaction])
