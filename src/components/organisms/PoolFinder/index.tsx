'use client'
import { Currency, ETHER, JSBI, TokenAmount } from '@gocheto-dex/sdk'
import React, { useCallback, useEffect, useState } from 'react'
import { Plus } from 'react-feather'
import { Text } from 'rebass'
import { ButtonDropdownLight } from '../../ButtonLegacy'
import { BlueCard, LightCard } from '../../Card'
import { AutoColumn, ColumnCenter } from '../../Column'
import CurrencyLogo from '../../CurrencyLogo'
import { FindPoolTabs } from '../../NavigationTabs'
                        ...
                        pairState === PairState.EXISTS ? (
                            ...
                            <LightCard padding="45px 10px">
                                <AutoColumn gap="sm" justify="center">
                                    ...
                                    <StyledInternalLink style={{ color: '#ffb73c' }} href={`/add/${currencyId(currency0)}/${currencyId(currency1)}`} className="hebbo-font">
                                        Create pool.
                                    </StyledInternalLink >
                                </AutoColumn>
                            </LightCard>
