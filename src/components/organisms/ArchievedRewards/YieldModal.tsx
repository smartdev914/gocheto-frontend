                    ...
                    item && (
                        ...
                        >
                            ...
                            <button onClick={onDismiss}>
                                ...
                                >
                                    <p>
                                   In order to claim your DIG returns, you must deposit your GLP (Gocheto Liquidity Provider) Tokens into the allocated pair box.</p>
                                <p className="pt-3">During the time that GLP token is deposited, returns are accrued in real time.
                                </p>
