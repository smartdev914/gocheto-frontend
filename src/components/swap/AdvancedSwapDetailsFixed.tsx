import { Trade, TradeType } from '@gocheto-dex/sdk'
            ...
            <AutoColumn style={{ padding: '0 16px' }}>
                ...
                <RowBetween>
                    ...
                    <RowFixed>
                        ...
                        <QuestionHelper text="A portion of each trade (0.3%) goes to liquidity providers (LP) as a protocol incentive, and (0.05%) to xSUSHI holders." />
                    </RowFixed>
                </RowBetween>
            </AutoColumn>
        </>
