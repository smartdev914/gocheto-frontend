...
export function colors(darkMode: boolean): Colors {
    return {
        ...
        // backgrounds / greys
        bg1: darkMode ? '#1b1d38' : '#FFFFFF',
        bg2: darkMode ? '#222540' : '#F7F8FA',
        bg3: darkMode ? 'rgb(15 17 45 / 1)' : '#EDEEF2',
        bg4: darkMode ? '#3a506f' : '#CED0D9',
        bg5: darkMode ? '#6C7284' : '#888D9B',

        //specialty colors
        modalBG: darkMode ? 'rgb(15 17 45 / 0.75)' : 'rgba(0,0,0,0.3)',
        advancedBG: darkMode ? 'rgba(15 17 45 / 0.3)' : 'rgba(255,255,255,0.6)',
