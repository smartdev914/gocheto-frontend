...
export default function AddLiquidity({ currencyIdA, currencyIdB }: { currencyIdA?: string; currencyIdB?: string }) {
    ...
    console.log("Router Address", getShibaSwapRouterAddress(chainId));
    ...
    return (
        <>
            ...
            <div className="dig-container flex container my-auto pb-10">
                <div className="dig mx-auto" id="digSection">
                                ...
                                <div className="inner justify-start">
                                    <div className="top">
                                        <div className="top-left">
                                            ...
                                            <div
                                                className="read-more mt-5 font-medium no-underline not-italic"
                                                onClick={() => {
                                                    setShowModal(true)
                                                }}
                                            >
                                                <div className="tooltips">
                                                    ...
                                                    <span className="hebbo-font">
                                                    Read this to understand Gocheto reward system
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="image-div mt-2">
                                            <Image src={DigImage} alt='Dig Image' width={40} height={40} />
                                        </div>
                                    </div>
